...
//                            .shadow(radius: 4)
                        ...
                        HStack(alignment: .center, spacing: 12) {
                            Image(materiel.image.isEmpty ? "placeholder" : materiel.image) // materiel.vendeur.image.isEmpty mais user a pas d'image
                                .resizable()
                                .scaledToFill()
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text(String(format: "%.1f ★", materiel.vendeur.score)) // je sais pas si score c'est sa note ou son niveau
                                    .secondaryText()
                                    .bold()
                            ...
                            Button(action: {}) { //TODO lier a la page du user
                                Text("Contacter")
                                    .buttonLabel()
